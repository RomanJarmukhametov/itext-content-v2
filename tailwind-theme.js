...
export default {
  ...
  global: {
    fieldset: "max-w-md border-[1px] border-gray-300 rounded px-2 pb-1",
    help: "text-xs text-gray-500",
    inner:
      "formkit-disabled:bg-gray-200 formkit-disabled:cursor-not-allowed formkit-disabled:pointer-events-none",
    input:
      "appearance-none bg-transparent focus:outline-none focus:ring-0 focus:shadow-none w-full",
  ...
  "family:box": {
    decorator:
      "block relative h-5 w-5 mr-2 rounded bg-white bg-gradient-to-b from-transparent to-gray-200 ring-1 ring-gray-400 peer-checked:ring-primary600 text-transparent peer-checked:text-primary600",
    decoratorIcon:
  ...
  "family:button": {
    input:
      "$reset w-full flex items-center justify-center bg-primary500 text-white text-sm font-semibold px-3.5 py-2.5 rounded-md hover:bg-primary600 transition-colors duration-300 focus-visible:outline-2 focus-visible:outline-primary500 focus-visible:outline-offset-2 formkit-disabled:bg-gray-400 formkit-loading:before:w-4 formkit-loading:before:h-4 formkit-loading:before:mr-2 formkit-loading:before:border formkit-loading:before:border-2 formkit-loading:before:border-r-transparent formkit-loading:before:rounded-3xl formkit-loading:before:border-white formkit-loading:before:animate-spin",
    wrapper: "mb-1",
  ...
  "family:dropdown": {
    ...
    inner:
      "w-full max-w-md relative flex ring-1 ring-gray-400 focus-within:ring-primary600 focus-within:ring-2 rounded mb-1 formkit-disabled:focus-within:ring-gray-400 formkit-disabled:focus-within:ring-1 [&>span:first-child]:focus-within:text-primary600",
    input: "w-full px-3 py-2",
    listbox: "bg-white shadow-lg rounded overflow-hidden",
    listboxButton: "flex w-12 self-stretch justify-center mx-auto",
    listitem:
      'pl-7 relative hover:bg-gray-300 data-[is-active="true"]:bg-gray-300 aria-selected:bg-primary700 aria-selected:text-white data-[is-active="true"]:aria-selected:bg-primary700 data-[is-active="true"]:aria-selected:bg-primary800',
    loaderIcon: "ml-auto",
    loadMoreInner:
      "flex items-center justify-center text-sm p-2 text-center w-full text-primary600 formkit-loading:text-gray-500 cursor-pointer [&>span]:mr-3 [&>span]:ml-0",
    option: "p-2.5",
  ...
  "family:text": {
    inner:
      "flex items-center ring-1 ring-gray-400 focus-within:ring-primary600 focus-within:ring-2 [&>label:first-child]:focus-within:text-primary600 rounded mb-1",
    input:
      "w-full px-3 py-2 border-none text-base text-gray-700 placeholder-gray-400",
  },
  "family:date": {
    inner:
      "flex items-center max-w-md ring-1 ring-gray-400 focus-within:ring-primary600 focus-within:ring-2 [&>label:first-child]:focus-within:text-primary600 rounded mb-1",
  ...
  file: {
    ...
    fileRemove:
      "relative z-[2] ml-auto text-[0px] hover:text-red-500 pl-2 peer-data-[has-multiple=true]:text-sm peer-data-[has-multiple=true]:text-primary600 peer-data-[has-multiple=true]:ml-3 peer-data-[has-multiple=true]:mb-2 formkit-multiple:bottom-[0.15em] formkit-multiple:pl-0 formkit-multiple:ml-0 formkit-multiple:left-[1em] formkit-multiple:formkit-prefix-icon:left-[3.75em]",
  ...
  select: {
    inner:
      "flex relative max-w-md items-center rounded mb-1 ring-1 ring-gray-400 focus-within:ring-primary600 focus-within:ring-2 [&>span:first-child]:focus-within:text-primary600",
    input:
  ...
  textarea: {
    inner:
      "flex rounded mb-1 ring-1 ring-gray-400 focus-within:ring-primary600 [&>label:first-child]:focus-within:text-primary600",
    input:
